    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <section className="card p-5">
        ...
        <ol className="space-y-3 text-[13px] text-ink-800">
          <Step n={0} title="施設情報を入力する" body="「マスタ・データ管理」→「施設情報を編集」から施設名・定員・住所などを設定します。施設名はヘッダーやダッシュボードに反映されます。" />
          <Step n={1} title="利用者を登録する" body="左メニュー「利用者」から「＋ 新規利用者」で氏名・部屋（半角英数字）・キーパーソンを登録します。" />
